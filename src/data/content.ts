  ...
  projects: [
    {
      ...
      evidence: [
        ...
        "On anchored prompt injection Sonnet 4.5 shows TR 0.150 while three other models read 0.000, but only Sonnet has the anchored n=20 row. At n=5 the Wilson upper bound is 0.434, so 'Sonnet is the only model that discloses' is not yet a powered claim and the repo refuses to make it",
        ...
        "persona_attribution (2026-09-23, judge gemma4:12b): with the gold bible the judge attributes 31 of 40 turns to the right persona (Wilson [0.625, 0.877]) but 21 of 40 once the bible's documented tells are stripped, under the surface baseline, so it reads the surface. Two pre registered kill rows fire and the task is recorded as negative; the swapped arm turned out to be the gold arm relabelled, a design gap the repo now names",
